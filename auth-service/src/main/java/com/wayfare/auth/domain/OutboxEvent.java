...
/**
 * Transactional outbox row (design §3.3). Written in the same transaction as the
 * state change; the Phase 3 poller publishes it to Kafka and stamps publishedAt.
 */
@Entity
@Table(name = "outbox")
